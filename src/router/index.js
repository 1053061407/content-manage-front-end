...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    name: '文章',
    children: [
      { path: 'hotSpot', component: _import('article/hotSpot'), name: '行业热点' },
      { path: 'companyInfo', component: _import('article/companyInfo'), name: '公司资讯' },
      { path: 'newArticle', component: _import('article/newArticle'), name: '新建文章' }
    ]
  },
  {
    path: '/employment',
    ...
    name: '招聘信息',
    children: [
      { path: 'allEmployInfo', component: _import('employment/allEmployInfo'), name: '所有招聘' },
      { path: 'newEmployment', component: _import('employment/newEmployment'), name: '新建招聘' }
    ]
  },
  {
    path: '/components',
